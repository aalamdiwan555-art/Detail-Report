...
class MainActivity : ComponentActivity() {
    ...
    private fun refreshUi() {
        ...
        binding.btnStartStop.isEnabled = DetectionService.isRunning ||
            (account.hasActiveLicense() && accessibility && overlay && capture)
    ...
    private fun startDetection() {
        val data = projectionData ?: return binding.btnScreenCapture.performClick()
